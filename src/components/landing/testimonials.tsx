...
const testimonials = [
  {
    quote:
      "I landed three interviews in two weeks after publishing my portfolio on myskillspage. The drag-and-drop builder made it incredibly easy to showcase my projects.",
    name: "Marcus Rivera",
